...
import { Bed, BookMarked, Hotel, IdCard, Phone, User } from "lucide-react";
...
const ProfileMiniCard = () => {
	...
	return (
		<Link href={"/student/profile/"} className="flex">
			<Card className="relative overflow-hidden w-full">
				<CardContent className="items-center h-full">
					<div className="grid h-full gap-2">
						...
						<div className="">
							<CardDescription>
								...
								<div className="text-center mt-2 flex gap-4 items-center justify-center">
									<Phone /> +91 {proData.phone}
								</div>
